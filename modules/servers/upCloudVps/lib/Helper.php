...
class Helper
{
    public static function getLang()
    {
        ...
        $language = isset($_SESSION['Language']) ? $_SESSION['Language'] : (isset($config['Language']) ? $config['Language'] : 'english');
        // Set default language to 'english' if not found
        $languageFile = file_exists($languageDir . $language . '.php') ? $language : 'english';
        // Check if language file exists, otherwise default to English
